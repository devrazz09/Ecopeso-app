...
export default function MerchandiseCard({ image, name, price, description } : ProductProps ){
    return(
        <div className="w-[49%] h-177 flex flex-col justify-between gap-2 rounded-[20px] shadow-[0px_0px_5px_1px_rgba(162,162,162,0.8)] p-6 font-semibold">
            <img className="w-full h-[55%] object-cover rounded-xl" src={image} alt="" />
